...
<div class="container">
    <div class="row">
        <div class="col-8">
            <h2 class="my-3">From Edit Data Barang</h2>
            <form action="/barang/update/<?= $barang['id_barang']; ?>" method="post" enctype="multipart/form-data">
                ...
                <div class=" row mb-3">
                    ...
                    <div class="col-sm-8">
                        <div class="custom-file">
                            ...
                            <label class="form-label" for="gambar"><?= $barang['gambar']; ?></label>
                ...
                <button type=" submit" class="btn btn-primary" onclick="return confirm('Apakah Yakin Ingin Menggubah Data ?')">Edit Data</button>
            </form>
        </div>
    </div>
</div>
